...
{
    [UIApplication sharedApplication].networkActivityIndicatorVisible = YES; //seems good here

    [NSThread sleepForTimeInterval:2.0]; //just to check the networkActivityIndicator
    ...
    [UIApplication sharedApplication].networkActivityIndicatorVisible = NO; //seems good here
